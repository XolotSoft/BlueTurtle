		...
		<div class="container">
			...
			<form action="" method="POST" role="form">
				...
				<div class="form-group">
					<label for="envRapSeg">Seguridad</label>
					<select name="" id="envRapSeg" class="form-control" required="required" onchange="envRapOp(this.value);">
						<option value=""></option>
					...
					<input type="text" name="palCla" id="palCla" class="form-control" value="" required="required" pattern="" title=""><br>
					<label for="conPal">Confirmar</label>
					<input type="text" name="conPal" id="conPal" class="form-control" value="" required="required" pattern="" title=""><br>	
					</div>
					<label for="email">eMail</label>
					<input type="email" name="email" id="email" class="form-control" value="" required="required" title=""><br>
					<label for="msj">Mensaje</label>
					<textarea name="" id="" cols="40" rows="5" class="form-control" required="required" maxlength="250"></textarea>
				</div>
